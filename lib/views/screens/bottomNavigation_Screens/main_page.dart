      ...
      Timer.periodic(oneTickPersec, (timer) {
        ...
        if (appState != 'REQUESTING') {
          ...
          if (requestTimeOut == 0) {
            ...
            //send notifcation to next nearest online available driver
        ...
        child: Drawer(
          child: ListView(
            ...
            children: [
              ...
              SwitchListTile(
                title: Text(
                  userInfo != null && userInfo!.userType == 'driver'
                      ? 'Switch to User'
                      : 'Switch to Driver',
                  style: GoogleFonts.montserrat(
                    fontWeight: FontWeight.bold,
                ...
                secondary: const Icon(
                  Icons.drive_eta, // Icon to indicate driving
                ),
                value: userInfo != null && userInfo!.userType == 'driver',
                onChanged: (bool isDriver) async {
                  if (!isDriver) {
                    // Switch back to User
                    // Implement this if needed
                  } else {
                    // Switch to Driver
                    await AuthController().switchToDriver(context);

                    // Navigate to DriverMainScreen after switching
